 ...
 * @author ADMIN
 */
public class InsertLoaiPhong extends javax.swing.JFrame {
    ...
    public void repect(){
        String result = new ListLoaiPhong().re();
        if(result== "ah"){
    ...
    public void Recuper(){
        ListLoaiPhong inf = new ListLoaiPhong();
        inf.Deplace();
        try{
            String rec = inf.gettalleresult();
            String request = "select * from LoaiPhong where MaLP = '"+rec+"'";
...
//        byte[] photo= imageData;
    ...
    private void initComponents() {
        ...
        jLabel9.setText("Edit Type Of Room");
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        try {
            String request = "insert LoaiPhong(MaLP, TenLP, DonViTinh, Gia) values(?,?,?,?);";
            ps = connection.prepareStatement(request);
        ...
        this.dispose();
        new ListLoaiPhong().Addichage();
    }//GEN-LAST:event_btnAddActionPerformed

    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
         String t1= txtId.getText();
       String request = "update LoaiPhong set MaLP = ?, TenLP=?,"
               + " DonViTinh=?, Gia=? where MaLP = '"+t1+"'";
        try {
            ps = connection.prepareStatement(request);
            ps.setString(1, txtId.getText());
            ps.setString(2, txtName.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InsertLoaiPhong.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InsertLoaiPhong().setVisible(true);
            }
        });
    }
