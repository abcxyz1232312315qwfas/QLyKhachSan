 ...
 * @author ADMIN
 */
public class ListDanhSachDoanhThu extends javax.swing.JInternalFrame {
    ...
    public void Addichage(){
        try{
            String request = "select MaHD as 'ID', MaDP as 'Ma Dat Phong', NgayLap as 'Ngay Lap', NgayTraPhong as 'Ngay Tra',TongTien from HoaDon";
